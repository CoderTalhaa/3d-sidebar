...
export default function Sidebar() {
  return (
    <div className="relative z-10 hidden lg:block ">
      <nav className="sticky top-0 min-h-[100svh] min-w-[275px] w-[16vw] p-[1.25vw] lg:p-[24px] flex flex-col">
        <h1
          className={`${jetBrainsMono.className} text-6xl text-orange mb-8 hidden lg:block`}
        >
          TALHA
        </h1>
